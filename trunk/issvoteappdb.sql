...
CREATE TABLE "NGUOI_DAN" (
    ...
    "ID_QUAN_ID" NVARCHAR2(10) NOT NULL UNIQUE REFERENCES "QUAN" ("ID_QUAN") DEFERRABLE INITIALLY DEFERRED
)
;
...
CREATE TABLE "TO_LAP_DANH_SACH" (
    ...
    "ID_KYBAUCU_ID" NVARCHAR2(10) NOT NULL REFERENCES "CUOC_BAU_CU" ("ID_KYBAUCU") DEFERRABLE INITIALLY DEFERRED,
    "ID_NGUOILAP" NVARCHAR2(10),
    "HO_DEM" NVARCHAR2(50),
    "TEN" NVARCHAR2(50),
    UNIQUE ("ID_KYBAUCU_ID", "ID_NGUOILAP")
)
;
...
CREATE TABLE "TO_THEO_GIOI" (
    ...
    "HO_DEM" NVARCHAR2(50),
    "TEN" NVARCHAR2(50),
    UNIQUE ("ID_KYBAUCU_ID", "ID_NGUOITHEODOI")
)
;
...
CREATE TABLE "TO_GIAM_SAT" (
    ...
    "HO_DEM" NVARCHAR2(50),
    "TEN" NVARCHAR2(50),
    UNIQUE ("ID_KYBAUCU_ID", "ID_NGUOIGIAMSAT")
)
;
...
CREATE TABLE "DANH_SACH_UNG_VIEN" (
    ...
    UNIQUE ("ID_KYBAUCU_ID", "UNG_VIEN_ID")
)
;
...
CREATE TABLE "DANH_SACH_CU_TRI" (
    ...
    "BAU_CHO_ID" NUMBER(11) NOT NULL REFERENCES "DANH_SACH_UNG_VIEN" ("ID") DEFERRABLE INITIALLY DEFERRED,
    UNIQUE ("ID_KYBAUCU_ID", "NGUOI_DAN_ID")
)
;
